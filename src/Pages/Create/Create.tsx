        ...
        <main className="h-128">
            ...
            <section className="flex flex-col justify-center items-center min-h-full gap-5">
                <div className="flex flex-col w-2/3">
                    ...
                    <input type="text" className="bg-transparent border-2 rounded-xl w-full h-10 text-neutral-50 focus:outline-none p-2" placeholder="7538239120000"/>
                </div>
                <div className="flex gap-5 items-center justify-center w-2/3">
                    <div className="flex flex-col w-2/4">
                        <label className="text-neutral-50">Product Name</label>
                        <input type="text" className="bg-transparent border-2 rounded-xl h-10 text-neutral-50 focus:outline-none p-2" placeholder="Notebook Aspire 5..."/>
                    </div>
                    <div className="flex flex-col w-2/4">
                        <label className="text-neutral-50">Product Mark</label>
                        <input type="text" className="bg-transparent border-2 rounded-xl h-10 text-neutral-50 focus:outline-none p-2" placeholder="Acer..."/>
                    </div>
                </div>
                <div className="flex gap-5 items-end w-2/3">
                    <div className="flex flex-col w-2/4">
                        <label className="text-neutral-50">Amount</label>
                        <input type="text" className="bg-transparent border-2 rounded-xl h-10 text-neutral-50 focus:outline-none p-2" placeholder="12"/>
                    </div>
